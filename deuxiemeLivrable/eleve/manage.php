        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
					...
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">add</i> <span>Add New users</span></a>
            ...
            <table class="table table-striped table-hover">
				...
				<td>
							<span class="custom-checkbox">
								<input type="checkbox" class="user_checkbox" data-user-id="<?php echo $row["ID_user"]; ?>">
					...
					<td>
						...
						<a href="#deleteEmployeeModal" class="delete" data-id="<?php echo $row["ID_user"]; ?>" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" 
			...
			<div class="modal-content">
				<form id="user_form">
					...
					<div class="modal-body">					
						...
						<div class="form-group">
							<label>Profile</label>
							<input type="profile" id="profile" name="profile" class="form-control" required>
						</div>					
					</div>
			...
			<div class="modal-content">
				<form id="update_form">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label>Prenom</label>
							<input type="prenom" id="prenom_u" name="prenom" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Username</label>
							<input type="username" id="username_u" name="username" class="form-control" required>
						</div>
						<div class="form-group">
							<label>Password</label>
						...
						<div class="form-group">
							<label>Profile</label>
							<input type="profile" id="profile_u" name="profile" class="form-control" required>
						</div>			
					</div>
					<div class="modal-footer">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					...
					<div class="modal-header">						
						<h4 class="modal-title">Delete utilisateur  </h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
					</div>
					<div class="modal-body">
