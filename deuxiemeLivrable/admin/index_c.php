  ...
  <body class="hold-transition login-page" style="background:#ffbb22">
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        <p class="login-box-msg">Connectez-vous pour demarrer la session</p>
        <form action="login.php" method="post">
          ...
          <div class="row">
			...
			<div class="col-xs-6 pull-right">
              <button type="submit" class="btn btn-primary btn-block btn-flat" name="login" default>Se connecter</button>
            </div><!-- /.col -->
          </div>
        </form>
