                    ...
                    <div class="login-content">
                        ...
                        <div class="login-form">
                            <form action="" method="post">
                                ...
                                <div class="form-group">
                                    <label>Prenom</label>
                                    <input class="au-input au-input--full" type="prenom" name="prenom" placeholder="Prenom" required>
                                </div>
                                <div class="form-group">
                                    <label>Nom</label>
                                    <input class="au-input au-input--full" type="nom" name="nom" placeholder="Nom" required>
                                </div>
                                <div class="form-group">
